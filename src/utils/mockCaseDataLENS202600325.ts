  ...
  const id1: AccountIdentifier = {
    ...
    checkAccounts: {
      ...
      relatedIdentifiers: [
        ...
        "andy.ryan@microsoft.com",
        "ANDYRYAN@microsoft.com",
        "andy.ryan@fbt.microsoft.com",
        "andyryan@exchange.microsoft.com",
        "andyryan@service.microsoft.com",
        "andyryan@xbox.com",
        "andyryan@titanium.microsoft.com",
        "andyryan@skype.net",
        "andyryan@service.exchange.microsoft.com",
        "andyryan@mgd.microsoft.com",
        "andrew_b_ryan@msn.com",
        "34001B0289502",
        "ANDYRYAN@ame.gbl",
        ...
        "Andy.Ryan_microsoft.com#EXT#@eceuropaeu.onmicrosoft.com",
      ...
      discoveredAccounts: [
        // ── PRIMARY: MSIT Enterprise ──
        {
          ...
          identifiers: [
            ...
            { identifier: "andy.ryan@fbt.microsoft.com", identifierType: "SmtpAddress", primary: false },
            { identifier: "andyryan@exchange.microsoft.com", identifierType: "SmtpAddress", primary: false },
            { identifier: "andyryan@service.microsoft.com", identifierType: "SmtpAddress", primary: false },
            { identifier: "andyryan@xbox.com", identifierType: "SmtpAddress", primary: false },
            { identifier: "andyryan@titanium.microsoft.com", identifierType: "SmtpAddress", primary: false },
            { identifier: "andyryan@skype.net", identifierType: "SmtpAddress", primary: false },
            { identifier: "andyryan@service.exchange.microsoft.com", identifierType: "SmtpAddress", primary: false },
            { identifier: "andyryan@mgd.microsoft.com", identifierType: "SmtpAddress", primary: false },
            { identifier: "andrew_b_ryan@msn.com", identifierType: "SmtpAddress", primary: false },
          ],
        },
        ...
        // ── RELATED: B2B guest in eceuropaeu ──
        {
          accountType: "EnterpriseUser",
          tenantId: "b24c8b06-522c-46fe-9080-70926f8dddb1",
          upn: "Andy.Ryan_microsoft.com#EXT#@eceuropaeu.onmicrosoft.com",
          category: "RELATED account - GuestAccount",
          disclosureRelevance: "RELEVANT",
          disclosureProcess: "Enterprise",
          identifiers: [
            { identifier: "Andy.Ryan_microsoft.com#EXT#@eceuropaeu.onmicrosoft.com", identifierType: "SmtpAddress", primary: true },
            { identifier: "Andy.Ryan@microsoft.com", identifierType: "SmtpAddress", primary: false },
            { identifier: "andyryan@microsoft.com", identifierType: "SmtpAddress", primary: false },
          ],
        },
