...
interface PreservationOrderActiveBannerProps {
  ...
  /** Click handler for the "Acknowledge Receipt" CTA. When omitted the
   *  CTA self-hides. Parent opens the correspondence composer with
   *  EPOC_PRESERVATION_ACK pre-attached. */
...
export function PreservationOrderActiveBanner({
  ...
  // Hide once preservation has ended — EndPreservationBanner owns the
  // terminal state.
  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0 space-y-1">
        ...
        {!acknowledged && onAcknowledgeReceipt && (
